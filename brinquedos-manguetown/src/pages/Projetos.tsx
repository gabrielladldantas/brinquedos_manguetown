const PROJETOS_DATA = [
  {
    ...
    descricao:
      "A iniciativa é voltada para o enfrentamento das mudanças climáticas e a conservação dos cursos d'água da cidade e tem como principal público alvo, estudantes de 10 a 13 anos de escolas municipais situadas no entorno do Riacho Cavouco, na Zona Oeste do Recife.",
  ...
  },
  {
    ...
    descricao:
      "A Associação dos Trapeiros de Emaús, Recife, é uma unidade do Movimento Emaús Internacional. O Movimento foi criado em 1949, na França, com o objetivo de ajudar as pessoas que sofreram grandes perdas com o advento da Segunda Guerra Mundial.",
  ...
  },
  {
    ...
    descricao:
      "A Casa Menina Mulher é uma organização não governamental, ONG, que desenvolve ações pedagógicas com crianças, adolescentes e jovens.",
